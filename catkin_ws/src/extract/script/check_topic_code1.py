...
class CheckTopic:
    ...
    def check_topic(self, data): 
        ...
        road_plane, road_plane_idx = self.find_road_plane(xyz_data)
        ...
        self.line_clustering(line, xyz_data, name="/constraint_model/images/lane_{}".format(self.counter))
    ...
    def thresholding(self, points, threshold=0.11):
        #min = 10%
        #Max = 30%
        ...
        return points[np.logical_and(points[:,3]>threshold_min, points[:,3]<threshold_max)]
    ...
    def find_road_plane(self, xyz_data):
        ...
        seg.set_distance_threshold(0.5) #0.3
