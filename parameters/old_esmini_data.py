    ...
    if fileDetails[1] == '.cutin' or fileDetails[1] == '.cutout':
        ...
        for point in points:
            ...
            for param in file_data['parameter']: 
                ...
                name = loc+'scenario_files/'+fileDetails[0]+"_"+_type+"_"+str(point)+"_"+str(count)+".xosc"
                if _type == 'cutin' or _type == 'cutout':
                    ...
                    for i in range(2000):
                        ...
                        for j in range(se.SE_GetNumberOfObjects()):
                            ...
                            milli_sec = "{:.1f}".format(obj_state.timestamp)
                            if sec >= 15:
                                continue
                            if j == 0:
                            ...
                            if j == 1:
                                ...
                                if milli_sec not in data['adversary_esmini_milli']['sec']:
                                    data['adversary_esmini_milli']['speed'].append(obj_state.speed*3.6)
                                    data['adversary_esmini_milli']['sec'].append(milli_sec)
                    ...
                    if len(sec_store['ego']) > 2:
                        all_data[str(point)].append(data)
                    count += 1
print("Finished")
print("Then")
...
if exist:
    ...
    if 'data' in esmini_file_data:
        esmini_file_data['data'].append(all_data)
